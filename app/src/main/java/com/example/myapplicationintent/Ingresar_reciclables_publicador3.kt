...
class Ingresar_reciclables_publicador3: AppCompatActivity() { // View Binding
    private lateinit var binding: IngresarReciclablesPublicador3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = IngresarReciclablesPublicador3Binding.inflate(layoutInflater)
    ...
    private fun regresarlanding() {

        val myIntent = Intent(
            this,Landing_publicador::class.java
        ).apply {
            // Se lanza la activity.
            //putExtra(Ingresar_reciclables_publicador3.MATERIAL, binding.spn1.selectedItem.toString())
            //putExtra(Ingresar_reciclables_publicador3.CANTIDAD, binding.txtCantidad.text.toString())
            //putExtra(Ingresar_reciclables_publicador3.UNIDAD, binding.spn2.selectedItem.toString())

            //sharedPreferencesEditor.put("myList", material)
        }
