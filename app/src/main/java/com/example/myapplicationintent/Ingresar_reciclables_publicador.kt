...
class Ingresar_reciclables_publicador: AppCompatActivity() { // View Binding
    private lateinit var binding: IngresarReciclablesPublicadorBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = IngresarReciclablesPublicadorBinding.inflate(layoutInflater)
        ...
        binding.btnAgregar2.setOnClickListener {
            agregarpublicacion2()
        }
        binding.btnPublicar.setOnClickListener {
            ...
            binding.myListView.onItemClickListener = object : AdapterView.OnItemClickListener {
                override fun onItemClick(
                    ...
                    Toast.makeText(
                        applicationContext,
                        "Select ${binding.myListView.getItemAtPosition(position)}",
                        Toast.LENGTH_LONG
                    ).show()
    ...
    private fun agregarpublicacion2() {
        ...
        val myIntent = Intent(
            this,
            Ingresar_reciclables_publicador2::class.java
        ).apply {
