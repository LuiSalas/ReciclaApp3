...
class Landing_publicador: AppCompatActivity() { // View Binding
    private lateinit var binding: LandingPublicadorBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = LandingPublicadorBinding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btnPublicaciones.setOnClickListener { Agregarpublicaicones() }
    }

    private fun Agregarpublicaicones() {
