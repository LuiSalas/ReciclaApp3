...
import com.example.myapplicationintent.databinding.IngresarReciclablesBinding
import com.example.myapplicationintent.databinding.IngresarReciclablesPublicadorBinding

class Ingresar_reciclables: AppCompatActivity() { // View Binding
    private lateinit var binding: IngresarReciclablesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = IngresarReciclablesBinding.inflate(layoutInflater)
        setContentView(binding.root)
        binding.btnAplica.setOnClickListener {
            agregarpublicacion2()
        }
    }
